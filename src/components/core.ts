...
export const LX: any =
{
     ...
     */
    addSignal( name: string, obj: any, callback: (value: any) => void )
    {
        obj[ name ] = callback;
     ...
     * @param {Object} options
     */
    emitSignal( name: string, value: any, options: Record<string, any> = {} )
    {
...
// function _createCommandbar( root : HTMLElement )
// {
...
// function setCommandbarState( value: boolean, resetEntries: boolean = true )
// {
