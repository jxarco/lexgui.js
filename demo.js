...
// Content
{
    ...
    // Editor
    {
        ...
        editorArea.addMenubar( m => {
            ...
            m.add( "Scene/Settings/Appearance" );
            m.add( "Scene/Settings/Tools");
            m.add( "Scene/Settings/Tools/Connect to database");
            m.add( "Scene/Settings/Tools/Export and import settings");
