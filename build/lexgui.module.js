...
function makeIcon( iconName, options = { } )
{
    ...
    if( data )
    {
        ...
        // Create internal icon if variant is the same as requested or there's no lucide/fallback data
        if( ( requestedVariant == variant ) || !lucideData )
        {
