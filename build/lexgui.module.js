...
function makeIcon( iconName, options = { } )
{
    ...
    const _createLucideIcon = ( name ) => {
        const lucideIcon = lucide[ name ] ?? lucide[ LX.LucideIconAlias[ name ] ];
        console.assert( lucideIcon, `No existing icon named _${ name }_` );
        return lucide.createElement( lucideIcon, options );
    }
    ...
    {
        svg = _createLucideIcon( iconName );
    }
...
LX.ICONS = {
    ...
    "AxisArrow": [24, 24, ["Axis3d"], "solid", "m12 2l4 4h-3v7.85l6.53 3.76L21 15.03l1.5 5.47l-5.5 1.46l1.53-2.61L12 15.58l-6.53 3.77L7 21.96L1.5 20.5L3 15.03l1.47 2.58L11 13.85V6H8z"],
    ...
    "Windows": [448, 512, [], "brands", "M0 93.7l183.6-25.3v177.4H0V93.7zm0 324.6l183.6 25.3V268.4H0v149.9zm203.8 28L448 480V268.4H203.8v177.9zm0-380.6v180.1H448V32L203.8 65.7z"],
